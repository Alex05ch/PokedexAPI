...
class UserCreate(UserBase):
    password: str  # se recibirá en texto plano y se hashéa en auth.py
...
class PokedexEntryCreate(PokedexEntryBase):
    """Body para POST /api/v1/pokedex"""
    pass


class PokedexEntryUpdate(SQLModel):
    """Body para PATCH /api/v1/pokedex/{entry_id}"""
...
class TeamCreate(TeamBase):
    """Body para POST /api/v1/teams"""
    pokemon_ids: List[int]  # máximo 6, se valida en el endpoint


class TeamUpdate(TeamBase):
    """Body para PUT /api/v1/teams/{team_id}"""
